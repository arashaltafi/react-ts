...
const Home = () => {
  ...
  return (
    <div className='py-16 px-8 flex flex-col justify-center items-center gap-16 bg-zinc-200'>
      ...
      <button className='text-2xl btnSuccess' onClick={() => navigate('/parallax')}>Parallax</button>
      ...
      <nav>
        ...
        <Link to='/parallax'><h1 className={'text-white text-center rounded-md shadow-lg text-xl m-4 p-4 bg-pink-400'}>Parallax</h1></Link>
